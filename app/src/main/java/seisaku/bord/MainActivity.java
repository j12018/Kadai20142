...
public class MainActivity extends Activity {
    ...
    Button btn_add;
    Button btn_del0, btn_del1, btn_del2, btn_del3, btn_del4, btn_del5, btn_del6;
                                ...
                                .setItems(str_items, new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                switch (which) {
                                                    ...
                                                    default:
                                                        // キャンセル
                                                        Toast.makeText(MainActivity.this, "キャンセルが選ばれました", Toast.LENGTH_LONG).show();
                                                        break;
                                                }
                                            }
                                        }
